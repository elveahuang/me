...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_banner" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"style" "enum_pages_blocks_banner_style" DEFAULT 'info' NOT NULL,
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_chat_memory_fk" FOREIGN KEY ("chat_memory_id") REFERENCES "public"."chat_memory"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "chat_memory_updated_at_idx" ON "chat_memory" USING btree ("updated_at");
  CREATE INDEX "chat_memory_created_at_idx" ON "chat_memory" USING btree ("created_at");
  ...
  CREATE INDEX "jwks_updated_at_idx" ON "jwks" USING btree ("updated_at");
  CREATE INDEX "jwks_created_at_idx" ON "jwks" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_chat_memory_id_idx" ON "payload_locked_documents_rels" USING btree ("chat_memory_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_jwks_id_idx" ON "payload_locked_documents_rels" USING btree ("jwks_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
    await db.execute(sql`
   DROP TABLE "chat_memory" CASCADE;
