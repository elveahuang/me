...
const PlanSchema = z.object({
    ...
    chatQuotaPerDay: planQuotaPerDayField.default(null),
    monthlyPriceCents: planMonthlyPriceCentsField.default(0),
    yearlyPriceCents: planYearlyPriceCentsField.default(null),
    enabled: z.boolean().default(true),
    sortOrder: planSortOrderField.default(0),
});
