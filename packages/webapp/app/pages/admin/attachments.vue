    ...
    <div class="space-y-6">
        ...
        <div class="app-card p-6">
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <input v-model="attKeyword" :placeholder="t('attachments.searchPlaceholder')" class="app-input !w-56 !py-1.5 !text-xs" />
            </div>
            ...
            <div v-if="attTotal > attPageSize" class="mt-3 flex items-center justify-end gap-2 text-xs">
                <button class="app-btn app-btn-outline app-btn-sm" :disabled="attPage <= 1" @click="goPage(attPage - 1)">上一页</button>
