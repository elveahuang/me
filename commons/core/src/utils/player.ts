...
import { XGWaterMarkConfig } from '@commons/core/components/player/plugins/XGWaterMarkPlugin.ts';
...
export interface XPlayerOptions extends IPlayerOptions {
    debug?: boolean;
    src?: string;
    watermark?: XGWaterMarkConfig;
}

export const defaultXPlayerOptions: XPlayerOptions = {
    debug: true,
    fluid: true,
    autoplay: true,
    playsinline: true,
