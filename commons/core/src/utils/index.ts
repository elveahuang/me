...
export const getAppCopyright = (): string[] => {
    ...
    return env.custom.enabled
        ? [t('app:copyright_1', { year: getYear() }), t('app:copyright_2'), t('app:copyright_3')]
        : [t('common:copyright_1', { year: getYear() }), t('common:copyright_2'), t('common:copyright_3')];
};
...
export const credentials: Credentials = {
    username: env.debug.enabled ? 'admin' : '',
    password: env.debug.enabled ? 'admin' : '',
};
