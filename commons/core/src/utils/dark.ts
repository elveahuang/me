 ...
 * 内置深色模式
 */
export const darkModes: Array<DarkModeType> = [
    {
        mode: DarkMode.AUTO,
        title: '跟随系统',
...
export const setDark = (dark: boolean): void => {
    if (dark) {
        ...
        if (document.querySelector('div.ai-editor')) {
            document.querySelector('div.ai-editor').classList.remove('aie-theme-light');
            document.querySelector('div.ai-editor').classList.add('aie-theme-dark');
        }
    } else {
        document.documentElement.classList.remove('dark');
        document.body.classList.remove('dark');
        if (document.querySelector('div.ai-editor')) {
            document.querySelector('div.ai-editor').classList.remove('aie-theme-dark');
            document.querySelector('div.ai-editor').classList.add('aie-theme-light');
        }
    }
};
